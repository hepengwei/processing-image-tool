          ...
          if (dataUrl) {
            ...
            image.onload = function () {
              ...
              if (width <= 20 || height <= 20) {
                ...
                init();
                message.error(getMessage("watermarkSizeLimit"));
                return;
              } else if (width > imgInfo.width || height > imgInfo.height) {
                setWatermarkInfo(null);
                init();
                message.error(getMessage("watermarkSizeTooLarge"));
                return;
              }
          ...
          <div className={styles.left}>
            <div className={styles.box}>
              <div className={styles.top}>
                ...
                {watermarkInfo ? watermarkInfo.name : getMessage("noData")}
              </div>
              {watermarkInfo && (
