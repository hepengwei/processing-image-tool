        ...
        <div className={styles.operationBtns}>
          <div className={styles.left}>
            {type === "clip" && (
              ...
              >
                {getMessage("whetherRetainOriginalDimension")}
              </Checkbox>
            )}
            <InputNumber
              className={styles.operationBtn}
              style={{
                width:
                  getMessage("@@ui_locale") === "zh_CN" ? "160px" : "200px",
              }}
              min={clipBoxMinWidthHeight}
              max={imgInfo.width}
              precision={0}
              value={clipBoxWidth}
              addonBefore={getMessage("clippingWidth")}
            ...
            <InputNumber
              ...
              precision={0}
              value={clipBoxHeight}
              addonBefore={getMessage("clippingHeight")}
              onChange={(value: number | null) => {
            ...
            <InputNumber
              ...
              style={{
                width:
                  getMessage("@@ui_locale") === "zh_CN" ? "160px" : "190px",
              }}
              min={0}
              max={imgInfo.width - clipBoxMinWidthHeight}
              precision={0}
              value={clipBoxLeft}
              addonBefore={getMessage("distanceLeft")}
              onChange={(value: number | null) => {
            ...
            <InputNumber
              ...
              precision={0}
              value={clipBoxTop}
              addonBefore={getMessage("distanceTop")}
              onChange={(value: number | null) => {
            ...
            {type === "mosaic" && (
              <InputNumber
                ...
                style={{
                  width:
                    getMessage("@@ui_locale") === "zh_CN" ? "200px" : "220px",
                }}
                min={2}
                max={40}
                precision={0}
                value={mosaicSize}
                addonBefore={getMessage("mosaicGrainSize")}
                onChange={(value: number | null) => {
